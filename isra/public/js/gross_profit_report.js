...
frappe.query_reports["Gross Profit"].onload = function(report) {
		...
		if (filters.group_by == "Invoice"){
			...
			frappe.run_serially([
				() =>
					...
					'?cmd=%(cmd)s&%(filters)s', {
					cmd: "isra.isra.custom_report.gross_profit.export_gross_profit_excel",
					filters: query
				})
			])
		}
		else{
			frappe.throw("Please choose Group by Invoice to download this excel report");
		}
	});
};
